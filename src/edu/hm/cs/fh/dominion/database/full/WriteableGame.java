...
public abstract class WriteableGame extends ReadonlyGame {
	 ...
	 *
	 * @param previousPlayedCard
	 *            the previousPlayedCard to set.
	 */
	public abstract void setToResolveActionCard(final Card previousPlayedCard);
