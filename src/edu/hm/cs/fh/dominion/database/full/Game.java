...
public class Game extends WriteableGame implements Changeable {
	...
	/** The last played kingdom card to resolve. */
	...
	public Optional<Card> getToResolveActionCard() {
		return Optional.ofNullable(actionCard);
	}

	@Override
	public void setToResolveActionCard(final Card toResolveActionCard) {
		actionCard = toResolveActionCard;
	}
