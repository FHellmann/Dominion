...
public class GuiController implements Initializable {
	 ...
	 *
	 * @param player
	 *            who called the update.
	 * @param game
	 *            with all data.
	 * @param optionalMove
	 *            which has been played.
	 */
	public void update(final ReadonlyGame game, final ReadonlyPlayer player, final Optional<Move> optionalMove) {
	 ...
	 *            to add.
	 * @param cardWidth
	 *            the cards have when they will be displayed.
	 */
	 ...
	 *            with all data.
	 * @param cardWidth
	 *            the cards have to be displayed.
	 */
	 ...
	 *
	 * @param pane
	 *            where the hand of the player is displayed.
	 * @param player
	 *            who has the cards.
	 * @param cardWidth
	 *            to display.
	 * @param showCards
	 *            if <code>true</code> the cards will be shown to the Java-FX player.
	 */
	 ...
	 *
	 * @param labelName
	 *            where the players name comes in.
	 * @param labelPoints
	 *            where the players victory points come in.
	 * @param player
	 *            who belongs to this data.
	 */
