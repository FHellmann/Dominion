...
public enum KingdomCard implements Card {
	...
	// // dir ablegen. Die �brigen aufgedeckten Karten legen die Spieler bei sich ab.
	...
	// }, (game, player) -> {
	// // Jeder Spieler (auch du selbst) muss die oberste Karte von seinem
	// // Nachziehstapel aufdecken. Du entscheidest, ob er sie ablegen oder zur�ck auf seinen
	// // Nachziehstapel legen muss.
	// }),
	// /** Throne room card */
	// THRONEROOM(game -> {
	// // Muss vorerst nicht implementiert werden
	 ...
	 */
	private KingdomCard(final Resolvable resolvable) {
	...
	private interface Resolvable {
		 ...
		 *
		 * @param game
		 *            to acess manipulating functions.
		 */
		public abstract void resolve(WriteableGame game);
	}
}
