...
public class Logic {
    ...
    public List<Move> findApplicableMoves(final ReadonlyPlayer player) {
        ...
        // TODO Stream.of(KingdomCard.values()).forEach(card -> allMoves.add(new ThroneroomAction(game, rwPlayer, card)));
        // TODO Stream.of(KingdomCard.values()).forEach(card -> allMoves.add(new ThroneroomActionResolve(game, rwPlayer, card)));
