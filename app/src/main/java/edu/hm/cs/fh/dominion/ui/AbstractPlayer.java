...
public abstract class AbstractPlayer implements UserInterface {
     ...
     *
     * @param strBuilder to append to.
     * @param card       to append.
     */
    private void appendCard(final StringBuilder strBuilder, final Card card) {
        if (getGame().getSupplyCardSet().anyMatch(supplyCard -> supplyCard.equals(card))) {
     ...
     *
     * @param strBuilder to append to.
     * @param player     to append.
     * @param number     of the player to mark and append.
     */
